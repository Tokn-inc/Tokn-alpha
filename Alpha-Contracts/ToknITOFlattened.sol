...
// File: contracts\ToknFactory.sol
/**
...
contract ToknFactory is ERC1155, IERC20, Pausable{
    ...
    function createInvestorTokns(string memory _symbol, uint _amount, string memory uri) public whenNotPaused{
        toknIdToArtist[++toknId] = msg.sender;
        symbolToId[_symbol] = toknId;
        artistTokns[msg.sender].push(toknId);
        toknIdToURI[toknId] = uri;
...
contract ToknITO is Pausable{
    ...
    constructor(ToknFactory _toknFactory, IERC20 _usdc){
